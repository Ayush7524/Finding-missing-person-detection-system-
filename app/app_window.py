...
class AppWindow(QMainWindow):
    ...
    def new_case(self):
        try:
            ...
            print("New case created successfully")
        except Exception as e:
            print(f"Error creating new case: {str(e)}")
    ...
    def refresh_model(self):
        try:
            ...
            print(f"Error refreshing model: {str(e)}")
            QMessageBox.about(self, "Error", f"Failed to refresh model: {str(e)}")
